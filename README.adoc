...
<2> This defines a custom storage handler (`STORED BY 'com.lucidworks.hadoop.hive.LWStorageHandler'`), which is the class included with the Hive SerDe jar.
...
==== Table Properties
Some of the following properties are optional.
